...
import { deleteCustomer, queryCustomer, updateFollower } from '@/services/customer'
...
const PublicCustomer = () => {
  ...
  const handleClickRead = (record: Customer) => {
    // TODO thing
  }
  ...
  const columns: ProColumns<Customer>[] = [
    ...
    },
    {
      ...
      valueType: 'option',
      render: (_, record) => [
        <a key="read" onClick={() => handleClickRead(record)}>查看</a>,
        <a key="transfer" onClick={() => handleClickTransfer(record)}>转为我的客户</a>,
        <a key="delete" onClick={() => handleClickDelete(record)}>删除</a>,
      ],
    },
  ]
